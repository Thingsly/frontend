...
<template>
  ...
  >
    <n-form-item
      :label="$t('device_template.table_header.eventName')"
      path="data_name"
    >
      <n-grid :cols="2">
        <n-gi>
    ...
    <n-form-item
      :label="$t('device_template.table_header.eventIdentifier')"
  ...
  >
    ...
    >
      ...
      <n-form-item
        :label="$t('device_template.table_header.commandDescription')"
      >
        <n-input
